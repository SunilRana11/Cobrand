...
(function ($) {
  ...
  $(".tptestimonial-active-two").slick({
    ...
    prevArrow:
      '<button type="button" class="slick-prev"><span><i class="fa-regular fa-angle-up"></i></span></button>',
    nextArrow:
      '<button type="button" class="slick-next"><span><i class="fa-regular fa-angle-down"></i></span></button>',
  ...
  $(".tp-accordion-seo .tp-accordion-item").on("click", function () {
    $(this)
      .addClass("tp-accordion-active")
      .siblings()
      .removeClass("tp-accordion-active");
    $(".tp-accordion-seo .tp-accordion-item.tp-accordion-active")
      .siblings()
      .find(".tp-accordion-content")
      .slideUp();
    $(
      ".tp-accordion-seo .tp-accordion-item.tp-accordion-active .tp-accordion-content"
    ).slideDown();
  });
